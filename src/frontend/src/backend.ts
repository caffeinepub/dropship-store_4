...
export class Backend implements backendInterface {
    ...
    async markEnquiryRead(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markEnquiryRead(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitOrder(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: number): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async updateProduct(arg0: bigint, arg1: string, arg2: string, arg3: number, arg4: string, arg5: string, arg6: boolean): Promise<void> {
        if (this.processError) {
            try {
